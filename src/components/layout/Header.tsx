...
export const Header: React.FC<HeaderProps> = ({ onMobileMenuToggle }) => {
  ...
  return (
    <header className="h-14 border-b border-border bg-card/95 sticky top-0 z-30 px-3 sm:px-6 flex items-center justify-between gap-2 sm:gap-4 pointer-events-auto">
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          className="lg:hidden h-9 w-9 shrink-0 flex items-center justify-center rounded-lg border-border"
        ...
        <Button
          ...
          className="hidden sm:flex items-center justify-start gap-2.5 px-3 h-8 w-44 md:w-64 text-xs text-muted-foreground hover:text-foreground border-border bg-muted/30 hover:bg-muted/60"
        >
      ...
      <div className="flex items-center">
        <Button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 h-9 text-xs border-border bg-muted/40 hover:bg-muted hover:border-primary/50 text-foreground dark:text-white shrink-0"
          aria-label="Open Command Palette"
        >
          <Command className="h-4 w-4 text-primary shrink-0" />
          <span className="hidden md:inline font-medium">Command Palette</span>
          <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border text-[10px] text-foreground dark:text-white font-mono hidden sm:inline-block">
            Ctrl + K
          </kbd>
        </Button>
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64 p-1.5 rounded-xl border border-border bg-popover shadow-xl text-xs">
              ...
              <DropdownMenuItem className="p-0 cursor-pointer">
                ...
                >
                  <div className="font-bold text-foreground dark:text-white">75K MT Coal (Primary)</div>
              ...
              <DropdownMenuItem className="p-0 cursor-pointer">
                <Link
                  ...
                  className="block px-2.5 py-2 rounded-lg hover:bg-muted w-full text-foreground"
                >
                  <div className="font-bold text-foreground dark:text-white">50K MT Coal</div>
              ...
              <div className="px-2.5 py-1.5 opacity-60 text-muted-foreground text-[11px]">
                <div className="font-semibold text-foreground dark:text-white">75K MT Coal (Mozambique)</div>
        ...
        <Button
          ...
          className="relative h-9 w-9 shrink-0 text-muted-foreground hover:text-foreground dark:hover:text-white flex items-center justify-center rounded-lg border-border"
          aria-label="View notifications"
        >
          <Bell className="h-4 w-4" />
          {unreadNotifCount > 0 && (
            <span className="absolute top-2 right-2 w-1.5 h-1.5 rounded-full bg-primary ring-2 ring-card animate-pulse" />
          )}
        </Button>
